...
サンプルをディレクトリ `07` の `lib/lib/stack/apigateway-stack.ts` にカスタムドメイン名の作成の処理を追加
...
export class CustomApiGatewayStack extends Stack {
  constructor(scope: Construct, id: string, props: CustomApiGatewayProps) {
    ...
    for (const valSet of jsonList) {
        ...
        //カスタムドメイン名 の作成
        const certificate = acm.Certificate.fromCertificateArn(this, "cert", "arn:aws:acm:ap-northeast-1:602744163118:certificate/a726294f-4259-4238-9858-a16a1910ebc8");
